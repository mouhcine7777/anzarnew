...
export default function BarSection() {
  ...
  return (
    <section
      ref={ref}
      className={`${mono.variable} ${body.variable} relative w-full overflow-hidden bg-[#3A0F16] px-6 py-20 text-[#F5EAD6] md:px-16 md:py-28`}
    >
        ...
        <div className="relative order-1 mx-auto w-full max-w-[560px] md:order-2" style={reveal(140)}>
          <div className="relative aspect-square w-full">
            ...
            <div className="absolute inset-[7%] overflow-hidden rounded-full ring-1 ring-[#B87D29]/40">
              ...
              />
              <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_120%,rgba(20,6,8,0.5)_0%,transparent_55%)]" />
            </div>
