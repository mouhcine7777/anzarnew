...
export default function HeroSection() {
  return (
    ...
    >
      ...
      {/* Grade */}
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(21,6,9,0.68)_0%,rgba(21,6,9,0.22)_36%,rgba(21,6,9,0.88)_100%)]" />
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(120%_90%_at_72%_18%,transparent_28%,rgba(12,4,6,0.82)_100%)]" />
