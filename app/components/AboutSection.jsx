...
export default function UniversSection() {
  ...
  return (
    <section
      ref={ref}
      className={`${mono.variable} ${body.variable} relative w-full overflow-hidden bg-[#722F38] px-6 py-24 text-[#F5EAD6] md:px-16 md:py-24`}
    >
      {/* Subtle warmth + vignette so the burgundy has depth, staying close to the maquette */}
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(85%_65%_at_50%_18%,rgba(84,24,34,0.5)_0%,transparent_65%)]" />
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(120%_90%_at_50%_120%,rgba(30,8,12,0.55)_0%,transparent_60%)]" />
      <div
