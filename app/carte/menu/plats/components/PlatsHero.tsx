...
/**
 * ANZAR — "Les Plats" hero. Scrolls to <div id="plats-menu-section">.
 * Image: /public/cuisine-3.jpg
 */
...
const PlatsHero = () => {
  const scrollToMenu = () => {
    document.getElementById("plats-menu-section")?.scrollIntoView({ behavior: "smooth", block: "start" });
  };
  ...
  return (
    ...
    >
      ...
      >
        <Image src="/cuisine-3.jpg" alt="Les plats d'Anzar" fill priority sizes="100vw" className="object-cover object-center" />
      </motion.div>
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-6xl items-end px-8 pb-20 md:px-16 md:pb-24">
        ...
        >
          ...
          >
            Les
            <br />
            <span className="text-[#B87D29]">plats</span>
          </motion.h1>
          ...
          >
            Poissons, viandes et créations orientales, sourcés avec la plus
            grande exigence.
          </motion.p>
