...
/**
 * ANZAR — "À partager" hero. Scrolls to <div id="a-partager-menu-section">.
 * Image: /public/cuisine-1.jpg
 */
...
const APartagerHero = () => {
  const scrollToMenu = () => {
    document.getElementById("a-partager-menu-section")?.scrollIntoView({ behavior: "smooth", block: "start" });
  };
  ...
  return (
    ...
    >
      ...
      >
        <Image src="/cuisine-1.jpg" alt="À partager chez Anzar" fill priority sizes="100vw" className="object-cover object-center" />
      </motion.div>
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-6xl items-end px-8 pb-20 md:px-16 md:pb-24">
        ...
        >
          ...
          >
            À
            <br />
            <span className="text-[#B87D29]">partager</span>
          </motion.h1>
          ...
          >
            Des créations conviviales à partager, pensées pour ouvrir la soirée
            en douceur.
          </motion.p>
