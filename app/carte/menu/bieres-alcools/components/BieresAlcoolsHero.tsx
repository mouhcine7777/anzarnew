...
/**
 * ANZAR — "Bières & Alcools" hero. Scrolls to <div id="bieres-alcools-menu-section">.
 * Image: /public/beers-drinks.jpg
 */
...
const BieresAlcoolsHero = () => {
  const scrollToMenu = () => {
    document.getElementById("bieres-alcools-menu-section")?.scrollIntoView({ behavior: "smooth", block: "start" });
  };
  ...
  return (
    ...
    >
      ...
      >
        <Image src="/beers-drinks.jpg" alt="Bières & alcools d'Anzar" fill priority sizes="100vw" className="object-cover object-center" />
      </motion.div>
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-6xl items-end px-8 pb-20 md:px-16 md:pb-24">
        ...
        >
          ...
          >
            Bières
            <br />
            <span className="text-[#B87D29]">&amp; alcools</span>
          </motion.h1>
          ...
          >
            Bières et spiritueux d&apos;exception, une collection pour chaque
...
export default BieresAlcoolsHero;
