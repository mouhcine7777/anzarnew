...
/**
 * ANZAR — "Les Entrées Froides" menu. Mirrors the Desserts page structure.
...
const EntreesFroidesMenu: React.FC = () => {
  const menuSections: MenuSection[] = [
    {
      title: "Les Entrées Froides",
      items: [
        { name: "Tartare de Crabe Crémeux sur un lit de Salade Chirazi", price: 200, detailedDescription: "Un tartare de crabe à la texture crémeuse, dressé sur un lit de salade chirazi pour la fraîcheur." },
        { name: "Salade de Chèvre Chaud et Fruits Secs", price: 190, detailedDescription: "Une salade qui joue le contraste entre le chèvre chaud et le croquant des fruits secs." },
        { name: "Salade de Gambas et Avocat", price: 185, detailedDescription: "Une salade fraîche associant gambas et avocat, en toute simplicité." },
        { name: "Carpaccio de Saumon", price: 190, detailedDescription: "Du saumon taillé en fines tranches et servi en carpaccio, tout en délicatesse." },
        { name: "Carpaccio de Bœuf", price: 190, detailedDescription: "Du bœuf taillé en fines tranches et servi en carpaccio." },
        { name: "Salade Terre & Mer", price: 195, detailedDescription: "Une salade qui réunit la terre et la mer dans une même assiette." },
        { name: "Gravlax de Saumon à la Betterave", price: 260, detailedDescription: "Un saumon travaillé en gravlax à la betterave, pour une entrée aussi fine que colorée." },
      ],
    },
  ];
  ...
  return (
    <div
      id="entrees-froides-menu-section"
...
export default EntreesFroidesMenu;
