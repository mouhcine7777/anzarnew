...
/**
 * ANZAR — "Les Entrées Froides" hero. Scrolls to <div id="entrees-froides-menu-section">.
 * Image: /public/cuisine-6.jpg
 */
...
const EntreesFroidesHero = () => {
  const scrollToMenu = () => {
    document.getElementById("entrees-froides-menu-section")?.scrollIntoView({ behavior: "smooth", block: "start" });
  };
  ...
  return (
    ...
    >
      ...
      >
        <Image src="/cuisine-6.jpg" alt="Les entrées froides d'Anzar" fill priority sizes="100vw" className="object-cover object-center" />
      </motion.div>
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-6xl items-end px-8 pb-20 md:px-16 md:pb-24">
        ...
        >
          ...
          >
            Entrées
            <br />
            <span className="text-[#B87D29]">froides</span>
          </motion.h1>
          ...
          >
            Des entrées délicates et fraîches, prélude raffiné à l&apos;expérience.
          </motion.p>
...
export default EntreesFroidesHero;
