...
/**
 * ANZAR — "Champagnes & Vins" hero. Scrolls to <div id="champagnes-vins-menu-section">.
 * Image: /public/champagne-wines.jpg
 */
...
const ChampagnesVinsHero = () => {
  const scrollToMenu = () => {
    document.getElementById("champagnes-vins-menu-section")?.scrollIntoView({ behavior: "smooth", block: "start" });
  };
  ...
  return (
    ...
    >
      ...
      >
        <Image src="/champagne-wines.jpg" alt="Champagnes & vins d'Anzar" fill priority sizes="100vw" className="object-cover object-center" />
      </motion.div>
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-6xl items-end px-8 pb-20 md:px-16 md:pb-24">
        ...
        >
          ...
          >
            Champagnes
            <br />
            <span className="text-[#B87D29]">&amp; vins</span>
          </motion.h1>
          ...
          >
            Champagnes d&apos;exception et grands crus, sélectionnés parmi les
            plus belles maisons.
          </motion.p>
...
export default ChampagnesVinsHero;
