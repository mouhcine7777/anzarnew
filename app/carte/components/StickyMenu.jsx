...
const CATEGORIES = [
  ...
  { category: "Les Entrées Froides", link: "/carte/menu/entrees-froides" },
  { category: "Les Plats", link: "/carte/menu/plats" },
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed inset-0 z-40 bg-[#160607]"
          >
            ...
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(70%_50%_at_50%_15%,rgba(122,47,56,0.35)_0%,transparent_60%)]" />
