...
export default function ArtistesSection() {
  ...
  const CTA = (
    <Link
      href="/artistes"
      className="group inline-flex items-center gap-3 border border-[#BC8B3A]/50 px-8 py-4 font-[family-name:var(--font-mono)] text-[0.68rem] font-medium uppercase tracking-[0.3em] text-[#F5EAD6] transition-colors duration-300 hover:border-[#B87D29] hover:bg-[#BC8B3A] hover:text-[#0E2E35]"
    >
  ...
  return (
    <section
      ref={ref}
      className={`${mono.variable} ${body.variable} relative w-full overflow-hidden bg-[#0E2E35] px-6 py-16 text-[#F5EAD6] md:px-16 md:py-28`}
    >
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col gap-10 md:grid md:grid-cols-[1fr_1.05fr] md:items-center md:gap-20">
        ...
        <div className="md:order-2" style={reveal(120)}>
          <div className="relative">
            ...
            <div className="relative aspect-[3/4] w-full overflow-hidden bg-[#0B2226] md:aspect-[4/5]">
              {ACTS.map((a, i) => (
                <Image
                  key={a.src}
                  src={a.src}
              ...
              <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[#081A1E] via-[#081A1E]/10 to-transparent" />
            ...
            {ACTS.map((a, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-[#081A1E]/30" />
