...
export default function ClosingSection() {
  ...
  return (
    <div className={`${mono.variable} ${body.variable} text-[#F5EAD6]`}>
      ...
      <section
        ref={vipRef}
        className="relative flex min-h-[78vh] w-full items-center justify-center overflow-hidden bg-[#0D262B] py-24 text-center md:min-h-[86vh]"
      >
        ...
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(120%_100%_at_50%_50%,rgba(11,34,38,0.55)_0%,rgba(11,34,38,0.9)_100%)]" />
        ...
        <div className="relative mx-auto max-w-2xl px-6">
          ...
          <div style={vipReveal(430)}>
            <Link
              href="/vip"
              className="group mt-11 inline-flex items-center gap-3 border border-[#B87D29]/60 bg-[#0D262B]/30 px-9 py-4 font-[family-name:var(--font-mono)] text-[0.68rem] font-medium uppercase tracking-[0.3em] text-[#F5EAD6] backdrop-blur-sm transition-colors duration-300 hover:border-[#B87D29] hover:bg-[#B87D29] hover:text-[#0D262B]"
            >
      ...
      <section className="border-t border-[#B87D29]/12 bg-[#0B2226] px-6 py-20 md:px-16">
        <div className="mx-auto grid max-w-5xl gap-14 md:grid-cols-2 md:gap-24">
          ...
          <div>
            ...
            <button
              ...
              className="group mt-7 inline-flex items-center gap-3 border border-[#B87D29]/50 px-8 py-3.5 font-[family-name:var(--font-mono)] text-[0.66rem] font-medium uppercase tracking-[0.3em] text-[#F5EAD6] transition-colors duration-300 hover:border-[#B87D29] hover:bg-[#B87D29] hover:text-[#0B2226]"
            >
              Rejoindre le Cercle
              <span className="transition-transform duration-300 group-hover:translate-x-1">→</span>
            </button>
      ...
      {/* ══ Footer ═══════════════════════════════════════════ */}
      <footer className="border-t border-[#B87D29]/12 bg-[#07171A] px-6 py-16 md:px-16">
      ...
      >
        <div className="absolute inset-0 bg-[#051317]/85 backdrop-blur-sm" onClick={() => setCercleOpen(false)} />

        <div
          className={`relative w-full max-w-md border border-[#B87D29]/25 bg-[#0D262B] p-8 shadow-[0_40px_80px_-30px_rgba(0,0,0,0.7)] transition-all duration-300 md:p-10 ${
        ...
        >
          ...
          {status === "success" ? (
            <div className="py-6 text-center">
              ...
              <button
                onClick={() => setCercleOpen(false)}
                className="mt-7 border border-[#B87D29]/50 px-7 py-3 font-[family-name:var(--font-mono)] text-[0.64rem] uppercase tracking-[0.3em] text-[#F5EAD6] transition-colors hover:bg-[#B87D29] hover:text-[#0D262B]"
              >
                Fermer
              </button>
            </div>
            ...
            <>
              ...
              <form onSubmit={submit} className="mt-7 space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-[#B87D29] px-8 py-3.5 font-[family-name:var(--font-mono)] text-[0.66rem] font-medium uppercase tracking-[0.3em] text-[#0D262B] transition-opacity hover:opacity-90 disabled:opacity-60"
                >
