...
export default function CarteHero() {
  ...
  return (
    <section
      className={`${mono.variable} ${body.variable} relative flex h-[100svh] min-h-[640px] w-full items-center justify-center overflow-hidden bg-[#0D262B] text-[#F5EAD6]`}
    >
      {/* Background */}
      <motion.div
      ...
      {/* Teal grade — kept light so the photo reads through */}
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(11,34,38,0.45)_0%,rgba(11,34,38,0.15)_40%,rgba(11,34,38,0.65)_100%)]" />
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_48%,rgba(7,23,26,0.6)_100%)]" />
      <div
      ...
      <div className="relative z-10 flex flex-col items-center px-6 text-center">
        ...
        >
          <button
            ...
            className="group mt-11 inline-flex items-center gap-3 border border-[#B87D29]/60 px-9 py-4 font-[family-name:var(--font-mono)] text-[0.68rem] font-medium uppercase tracking-[0.3em] text-[#F5EAD6] transition-colors duration-300 hover:border-[#B87D29] hover:bg-[#B87D29] hover:text-[#0D262B]"
          >
            Découvrir la carte
